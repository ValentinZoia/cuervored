                ...
                {matches?.length > 0 ? (
                    <ul className="divide-y divide-border">
                        {matches.map((match, index) => (
                            <li
                                key={index}
                                className="p-3 hover:bg-border transition-colors cursor-pointer"
                            >
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        <Image
                                            src={
                                                match.homeOrAway === "L"
                                                    ? "https://api.promiedos.com.ar/images/team/igf/1"
                                                    : (match.opponentImage as string)
                                            }
                                            alt={
                                                match.homeOrAway === "L"
                                    ...
                                    <div className="mt-2 flex justify-between">
                                        {match.isPastMatches ? (
                                            <CaslaButton
                                                size="sm"
                                                variant="redToBlue"
                                                aria-label="Ver quienes fueron"
                                                onClick={() => {
                                                    handleClick(match.customId);
                                                }}
                                            >
                                                Ver quienes fueron
                                            </CaslaButton>
